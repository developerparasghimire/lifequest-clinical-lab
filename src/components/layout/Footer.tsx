...
const linkGroups = [
  {
    heading: "Patients",
    links: [
      { href: "/services/lab-tests", label: "Book a Test" },
  ...
  },
  {
    heading: "Quick Links",
    links: [
      { href: "/services/lab-tests", label: "Test Menu" },
      { href: "/blog", label: "Health Blog" },
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              {fb && (
                <a href={fb} aria-label="Facebook" className="flex h-9 w-9 items-center justify-center rounded border transition-colors hover:bg-[#00B67A] hover:border-[#00B67A]" style={{ borderColor: "rgba(255,255,255,0.15)", color: "rgba(255,255,255,0.7)" }}>
              ...
              {ig && (
                <a href={ig} aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded border text-sm transition-colors hover:bg-[#00B67A] hover:border-[#00B67A]" style={{ borderColor: "rgba(255,255,255,0.15)", color: "rgba(255,255,255,0.7)" }}>
              ...
              {tw && (
                <a href={tw} aria-label="Twitter" className="flex h-9 w-9 items-center justify-center rounded border text-sm transition-colors hover:bg-[#00B67A] hover:border-[#00B67A]" style={{ borderColor: "rgba(255,255,255,0.15)", color: "rgba(255,255,255,0.7)" }}>𝕏</a>
              )}
              {wa && (
              ...
              <ul className="space-y-3">
                {g.links.map((l) => (
                  <li key={l.label}>
                    <Link
                      href={l.href}
                      className="text-sm transition-colors hover:text-[#00B67A]"
            ...
            <ul className="space-y-4">
              {email && (
                <li className="flex gap-3 items-start">
                  ...
                  <a href={`mailto:${email}`} className="text-sm break-all hover:text-[#00B67A] transition-colors" style={{ color: "rgba(255,255,255,0.5)" }}>
                    {email}
                  </a>
                </li>
              )}
              <li className="flex gap-3 items-start">
                ...
                <a href="tel:+97714002747" className="text-sm hover:text-[#00B67A] transition-colors" style={{ color: "rgba(255,255,255,0.5)" }}>
                  +977-1-4002747
                </a>
              </li>
              {hours && (
