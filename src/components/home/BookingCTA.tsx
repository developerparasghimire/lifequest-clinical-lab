    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <Reveal>
          ...
          <div className="flex flex-wrap gap-3 mt-10">
            {perks.map((b) => (
              ...
              >
                <span className="flex h-4 w-4 items-center justify-center rounded-full text-white text-[10px] font-bold" style={{ background: "#00B67A" }}>✓</span>
                {b}
              </span>
            ))}
          </div>
        ...
        <Reveal direction="left" delay={0.15}>
          ...
          >
            {/* Glow */}
            <div className="absolute -inset-1 rounded-3xl blur-2xl opacity-60" style={{ background: "linear-gradient(135deg,#00B67A,#00c6ff)" }} />

            <div className="relative rounded-2xl glass-dark p-6 sm:p-7 shadow-premium">
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl flex items-center justify-center text-white" style={{ background: "#00B67A" }}>
